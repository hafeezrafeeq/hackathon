...
function Navbar() {
    ...
    return (
        <motion.div
            ...
            className="fixed top-0 z-999 left-0  w-full backdrop-blur-md py-5 px-6 md:px-12 lg:px-14 flex font-[r-neue] items-center justify-between text-white transition-transform duration-500"
        >
            {/* Logo */}
            <div className="logo">
                <div className="logo">
