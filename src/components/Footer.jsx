...
function Footer() {
    ...
    return (
        <div
            data-scroll data-scroll-speed='.2' data-scroll-section
            className='h-screen w-full bg-[#cdea68]'>
            <h1 className='font-[founders] text-black text-center pt-20 text-[14vw] leading-[10vw] uppercase'>Ready <br />
                to start <br />
                the project</h1>

            <div className='flex items-center justify-center bg-cover bg-center '>{[0, 1].map((i) => (
                <div
                    key={i}
